...
public interface OpenAIReportGenTagAgent {
    @UserMessage("""
        ...
        """)
    @Tool(name = "openAIReportWithGenTags", value = "Creates a markdown form for the student feedback report based on reportLength, studenName, courseName and the response of another agent.")
    String openAIReportWithGenTags(String reportLenght ,String studentName, String courseName, String agentRespone);
}
