...
public interface OpenAIObsMapperWithGenTagConceptAgent {
    @UserMessage("""
        ...
        """)
    @Tool(name = "openAIMapCompetencesWithGenTags", value = "Maps observations to competences based on the course name and competence tags.")
    String openAIMapCompetencesWithGenTags(String courseName, List<String> observationsWithTags);
}
