...
import org.ba.infrastructure.bots.openai.report.OpenAIReportAgent;
...
public interface OpenAITagConceptAgent {
    ...
    @UserMessage("""
        ...
        Task 1: Map the observastions to the competences of the given courseName using the method: 'openAIMapCompetencesWithTags' and the missing values of courseName, the list of observationsWithTags.
        ...
        """)
    @ToolBox({OpenAIObsMapperWithTagConceptAgent.class, OpenAIReportAgent.class, TimestampCalculator.class})
