...
public interface OpenAIObsMapperWithTagConceptAgent {
    @UserMessage("""
        ...
        """)
    @Tool(name = "openAIMapCompetencesWithTags", value = "Maps observations to competences based on the course name and competence tags.")
    String openAIMapCompetencesWithTags(String courseName, List<String> observationsWithTags);
}
