...
public interface OllamaGenTagConceptAgent {
    @SystemMessage("""
        /no_think
    ...
    @UserMessage("""
        ...
        Task 1: Map the observastions to the competences of the given courseName using the method: 'mapCompetencesWithGenTags' and the missing values of courseName, the list of observationsWithTags.
        Task 2: Create a markdown form for the student feedback report using the result of Task 1 using the method: 'reportWithGenTags' and the missing values of reportLength, studentName, courseName and the response of Task 1.
        ...
        """)
    @ToolBox({OllamaObsMapperWithGenTagConceptAgent.class, OllamaReportGenTagAgent.class, TimestampCalculator.class})
