...
class EventSortReasonEditView extends StatefulWidget {
  final Function(String) onSave;

  const EventSortReasonEditView({
    super.key,
    required this.onSave,
  });

  @override
  State<EventSortReasonEditView> createState() =>
      _EventSortReasonEditViewState();
}

class _EventSortReasonEditViewState extends State<EventSortReasonEditView> {
  int _selectedIndex = 0;
  final List<String> _options = ["alphabeticASC", "alphabeticDESC"];

  @override
  Widget build(BuildContext context) {
    return GenericSettingsFormView<EventSortReasonCubit,
            GetSettingsStringState, String>(
        title: "Event Sort Reason",
        fieldLabel: "Sort Reason",
