...
class LearnerSortOrderEditView extends StatefulWidget {
  final Function(String) onSave;

  const LearnerSortOrderEditView({
    super.key,
    required this.onSave,
  });

  @override
  State<LearnerSortOrderEditView> createState() =>
      _LearnerSortOrderEditViewState();
}

class _LearnerSortOrderEditViewState extends State<LearnerSortOrderEditView> {
  int _selectedIndex = 0;
  final List<String> _options = ["ASC", "DESC"];

  @override
  Widget build(BuildContext context) {
    return GenericSettingsFormView<LearnerSortOrderCubit,
            GetSettingsStringState, String>(
        title: "Learner Sort Order",
        fieldLabel: "Order",
